			...
			<div class="item">
				<div class="latest-news">
					...
					<div class="latest-news-image">
						<a href="#">
							<img src="<?php bloginfo('stylesheet_directory');?>/assets/images/blog/test.jpg">
						</a>
					</div>
		...
		<div class="recent-post">
			...
			<div class="recent-post-item">
				<div class="row">
					<!-- Item Image -->
					<div class="col-md-4">
						<img src="<?php bloginfo('stylesheet_directory');?>/assets/images/corporate-team/team-1.jpg">
					</div>
					<!-- Item Tite -->
